package com.plotnikova.lab3_plotnikova_android
...
import com.plotnikova.lab3_plotnikova_android.ui.theme.Lab3_Plotnikova_AndroidTheme
...
fun GreetingImage(message: String, from: String, modifier: Modifier = Modifier) {
    val image = painterResource(R.drawable.pixelcastle)
    Box(modifier) {
        Image(
            painter = image,
